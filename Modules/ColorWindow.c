       ...
       if (Message = (struct IntuiMessage *) GT_GetIMsg (ColorWin->UserPort))
       {
          ...
          switch (MyClass)
          {
                 ...
                 case IDCMP_GADGETUP      : switch (MyGad->GadgetID)
                                            {
                                                    case ACCEPT  : GetRGB32 (ViewPortAddress (ColorWin)->ColorMap,0L,Colors,&Palette32 [1L]);

                                                                   Exit = TRUE;

                                                                   break;

                                                    case RESET   : KeepPalette (Win);
                                                    ...
                                                    case CANCEL  : LoadRGB32 (ViewPortAddress (ColorWin),Palette32);
                                                    ...
                                                    case PALETTE : GT_GetGadgetAttrs (MyPaletteGad,ColorWin,NULL,GTPA_Color,&SelectedPen);
