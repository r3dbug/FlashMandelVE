 ...
 * 39.10 - 8/93 - add comment about MAXAMDEPTH
 * 39.11 - 9/93 - add NoCenter arg to clipit
 */
 ...
 * Used only for OS < V37 by screen.c maxdisplaydepth(ULONG displayid)
 */
#define MAXAMDEPTH 8
...
UWORD maxdisplaydepth(ULONG displayid);
